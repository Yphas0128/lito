package com.oltocoder.boot.ssodemo.client;

import com.oltocoder.boot.ssodemo.client.dto.CommonResult;
import com.oltocoder.boot.ssodemo.client.dto.user.UserInfoRespDTO;
import com.oltocoder.boot.ssodemo.client.dto.user.UserUpdateReqDTO;
