package com.oltocoder.boot.framework.operatelog.core.aop;
...
import com.oltocoder.boot.framework.operatelog.core.service.OperateLog;
import com.oltocoder.boot.framework.operatelog.core.service.OperateLogFrameworkService;
import com.oltocoder.boot.framework.web.core.util.WebFrameworkUtils;
...
import static com.oltocoder.boot.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.oltocoder.boot.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.oltocoder.boot.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.oltocoder.boot.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.oltocoder.boot.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.oltocoder.boot.framework.operatelog.core.annotations.OperateLog operateLog,
