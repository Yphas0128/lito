package com.oltocoder.boot.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import com.oltocoder.boot.framework.social.core.enums.AuthExtendSource;
import com.oltocoder.boot.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class OltoAuthRequestFactory extends AuthRequestFactory {
    ...
    public OltoAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
