package com.oltocoder.boot.framework.tenant.core.mq;

import cn.hutool.core.util.StrUtil;
import com.oltocoder.boot.framework.mq.core.interceptor.RedisMessageInterceptor;
import com.oltocoder.boot.framework.mq.core.message.AbstractRedisMessage;
import com.oltocoder.boot.framework.tenant.core.context.TenantContextHolder;

import static com.oltocoder.boot.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
