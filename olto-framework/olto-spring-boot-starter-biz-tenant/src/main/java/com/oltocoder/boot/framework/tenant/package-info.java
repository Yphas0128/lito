 ...
 *      1）Spring Async：
 *          {@link com.oltocoder.boot.framework.quartz.config.OltoAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 OltoSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.oltocoder.boot.framework.tenant;
