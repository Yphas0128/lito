package com.oltocoder.boot.framework.tracer.config;

import com.oltocoder.boot.framework.common.enums.WebFilterOrderEnum;
import com.oltocoder.boot.framework.tracer.core.aop.BizTraceAspect;
import com.oltocoder.boot.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "olto.tracer", value = "enable", matchIfMissing = true)
public class OltoTracerAutoConfiguration {
