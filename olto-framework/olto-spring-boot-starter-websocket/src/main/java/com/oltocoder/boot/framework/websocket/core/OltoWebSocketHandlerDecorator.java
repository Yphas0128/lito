package com.oltocoder.boot.framework.websocket.core;
...
public class OltoWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public OltoWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
