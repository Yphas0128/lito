package com.oltocoder.boot.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 com.oltocoder.boot.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
