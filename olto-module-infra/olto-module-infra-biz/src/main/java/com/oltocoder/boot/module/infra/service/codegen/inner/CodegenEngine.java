package com.oltocoder.boot.module.infra.service.codegen.inner;
...
import com.oltocoder.boot.framework.common.exception.util.ServiceExceptionUtil;
...
import com.oltocoder.boot.framework.common.util.object.ObjectUtils;
import com.oltocoder.boot.framework.excel.core.annotations.DictFormat;
import com.oltocoder.boot.framework.excel.core.convert.DictConvert;
import com.oltocoder.boot.framework.excel.core.util.ExcelUtils;
...
import com.oltocoder.boot.framework.operatelog.core.enums.OperateTypeEnum;
...
import com.oltocoder.boot.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "olto-module-${table.moduleName}/" + // 顶级模块
                "olto-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "olto-module-${table.moduleName}/" + // 顶级模块
                "olto-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "olto-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "olto-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
}
