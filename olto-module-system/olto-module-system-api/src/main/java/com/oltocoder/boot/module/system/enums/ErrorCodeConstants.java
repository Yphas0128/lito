package com.oltocoder.boot.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 站内信发送 1002029000 ==========
    ErrorCode DEVICE_IS_EXISTS  = new ErrorCode(1002029000, "采集设备已存在");
    ErrorCode PROTOCOL_IS_EXISTS  = new ErrorCode(1002029001, "协议已存在");
    ErrorCode COLLECTOR_IS_EXISTS  = new ErrorCode(1002029002, "采集设备已被绑定");

    ErrorCode PROTOCOL_EXISTS_ERROR  = new ErrorCode(1002029003, "系统错误");

    ErrorCode PROTOCOL_IS_BIND  = new ErrorCode(1002029001, "协议已被绑定");
}
