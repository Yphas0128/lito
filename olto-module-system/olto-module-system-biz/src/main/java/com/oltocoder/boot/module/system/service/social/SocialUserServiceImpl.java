package com.oltocoder.boot.module.system.service.social;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.lang.Assert;
import com.oltocoder.boot.framework.common.util.http.HttpUtils;
import com.oltocoder.boot.framework.social.core.OltoAuthRequestFactory;
import com.oltocoder.boot.module.system.api.social.dto.SocialUserBindReqDTO;
import com.oltocoder.boot.module.system.dal.dataobject.social.SocialUserBindDO;
import com.oltocoder.boot.module.system.dal.dataobject.social.SocialUserDO;
import com.oltocoder.boot.module.system.dal.mysql.social.SocialUserBindMapper;
import com.oltocoder.boot.module.system.dal.mysql.social.SocialUserMapper;
...
import static com.oltocoder.boot.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 OltoAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private OltoAuthRequestFactory oltoAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = oltoAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
