package com.oltocoder.boot.server;
...
public class ProjectReactor {
    private static final String GROUP_ID = "com.oltocoder.boot";
    private static final String ARTIFACT_ID = "olto";
    private static final String PACKAGE_NAME = "com.oltocoder.boot";
    private static final String TITLE = "olto管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.oltocoder.boot";
        String artifactIdNew = "olto";
        String packageNameNew = "com.oltocoder.boot";
        String titleNew = "olto管理系统";
